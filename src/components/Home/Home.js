    ...
    return (
      <div>
        <div className="image-container">
          ...
          <div className="about">
            <i>A site designed to "Inspire" Developers and Designers </i>
            <br />
            <hr />Visit StoryCards to vote on your favorite websites <br /> Or{" "}
            <br />Take a look at Resources for tips & tricks of the trade
          </div>
          <div className="masonry">
            ...
            <div className="items">
              <img
                src="https://firebasestorage.googleapis.com/v0/b/personal-project-3598c.appspot.com/o/Home%20Images%2F2.png?alt=media&token=f8f291e9-23e8-4d60-b307-64720fc23751"
                alt="Learning to code is always learning"
              />
            </div>
            <div className="items">
              <img
            ...
            <div className="items">
              <img
                src="https://firebasestorage.googleapis.com/v0/b/personal-project-3598c.appspot.com/o/Home%20Images%2F1.png?alt=media&token=100c4f48-052b-4b1d-b8c6-39a3275b605d"
                alt="Coding is life"
              />
            </div>
            <div className="items">
